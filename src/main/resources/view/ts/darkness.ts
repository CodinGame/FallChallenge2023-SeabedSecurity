...
import { DARK_SCAN_RANGE, LIGHT_SCAN_RANGE } from './gameConstants.js'
import { fit } from './utils.js'

export const DISC_RADIUS = 218
const FOG_SCALE = 0.4

export function initDarkness (this: ViewModule, layer: PIXI.Container) {
  if (this.canvasMode) {
    return
  }
